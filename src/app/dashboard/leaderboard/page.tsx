...
const TOP_DEVELOPERS = [
  { rank: 1, name: 'ALICE_AUDIT', address: '0xaa1...f9a', completed: 18, earned: '45,000 USDC', successRate: 100, badge: 'ELITE' },
  { rank: 2, name: 'BOB_BUILDER', address: '0xbb2...e8b', completed: 12, earned: '28,500 USDC', successRate: 98, badge: 'EXPERT' },
  { rank: 3, name: 'CHARLIE_CODE', address: '0xcc3...d7c', completed: 9, earned: '19,200 USDC', successRate: 95, badge: 'PRO' },
  { rank: 4, name: 'DAVE_DEV', address: '0xdd4...c6d', completed: 7, earned: '15,000 USDC', successRate: 100, badge: 'PRO' },
  { rank: 5, name: 'EVE_EXPLOIT', address: '0xee5...b5e', completed: 4, earned: '8,500 USDC', successRate: 90, badge: 'RISING' }
]
        ...
        <motion.div variants={itemVariants} className="glass p-6 rounded-sm relative group">
          ...
          <div className="space-y-3">
            {TOP_DEVELOPERS.map((dev) => (
              <div key={dev.rank} className="bg-gray-900/40 border border-gray-800/50 p-4 rounded-sm flex items-center gap-4 hover:border-purple-400/50 hover:bg-purple-400/5 transition-all cursor-default relative overflow-hidden group/row">
